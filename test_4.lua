...
function Library:Window(title)
    local base_width = is_mobile and 280 or 320
    local base_height = is_mobile and 38 or 42
    local content_height = is_mobile and 400 or 450
    ...
    window_frame.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
    ...
    window_background.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
    ...
    window_shadow.ImageTransparency = 0.9
    ...
    container_scroll.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
    ...
    container_layout.Padding = UDim.new(0, is_mobile and 10 or 12)
    ...
    close_button.Activated:Connect(toggle_container)

    container_layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        container_scroll.CanvasSize = UDim2.new(0, 0, 0, container_layout.AbsoluteContentSize.Y + 15)
    end)
    ...
    local start_pos
    local start_size
    local min_width = is_mobile and 200 or 240
    local min_height = is_mobile and 120 or 160
    local max_width = 550
    ...
    function window_methods:button(name, callback)
        local button_height = is_mobile and 38 or 42
        ...
        button_name.Font = Enum.Font.GothamMedium
        ...
        button.Activated:Connect(on_click)
    ...
    function window_methods:toggle(name, callback)
        local toggle_height = is_mobile and 38 or 42
        ...
        toggle_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        toggle_name.Font = Enum.Font.GothamMedium
        toggle_name.Text = name
        toggle_name.TextColor3 = Color3.fromRGB(230, 230, 230)
        toggle_name.TextSize = is_mobile and 13 or 14
        toggle_name.TextXAlignment = Enum.TextXAlignment.Left
        
        toggle_button.Name = "ToggleButton"
        toggle_button.Parent = toggle_container
        toggle_button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        toggle_button.Position = UDim2.new(0.78, 0, 0.22, 0)
        toggle_button.Size = UDim2.new(0, is_mobile and 50 or 56, 0, is_mobile and 24 or 28)
        ...
        toggle_indicator.BackgroundColor3 = Color3.fromRGB(120, 120, 120)
        toggle_indicator.BorderSizePixel = 0
        toggle_indicator.Position = UDim2.new(0.05, 0, 0.1, 0)
        toggle_indicator.Size = UDim2.new(0, is_mobile and 18 or 20, 0, is_mobile and 18 or 20)
        ...
        local function toggle_state()
            ...
            if is_toggled then
                game:GetService("TweenService"):Create(toggle_indicator, TweenInfo.new(0.25), {
                    Position = UDim2.new(0.52, 0, 0.1, 0),
                    BackgroundColor3 = Color3.fromRGB(0, 200, 255)
                }):Play()
                game:GetService("TweenService"):Create(toggle_button, TweenInfo.new(0.25), {
        ...
        toggle_button.Activated:Connect(toggle_state)
    ...
    function window_methods:slider(name, min_value, max_value, default_value, callback)
        local slider_height = is_mobile and 52 or 56
        ...
        slider_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        slider_name.Size = UDim2.new(0.6, 0, 0, 22)
        slider_name.Font = Enum.Font.GothamMedium
        slider_name.Text = name
        slider_name.TextColor3 = Color3.fromRGB(230, 230, 230)
        slider_name.TextSize = is_mobile and 13 or 14
        ...
        slider_value.Size = UDim2.new(0.25, 0, 0, 22)
        ...
        slider_fill.BackgroundColor3 = Color3.fromRGB(0, 200, 255)
    ...
    function window_methods:dropdown(name, options, callback)
        local dropdown_height = is_mobile and 38 or 42
        ...
        dropdown_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        dropdown_name.Font = Enum.Font.GothamMedium
        dropdown_name.Text = name
        dropdown_name.TextColor3 = Color3.fromRGB(230, 230, 230)
        dropdown_name.TextSize = is_mobile and 13 or 14
        ...
        dropdown_button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        dropdown_button.Position = UDim2.new(0.7, 0, 0.22, 0)
        dropdown_button.Size = UDim2.new(0.25, 0, 0, is_mobile and 24 or 28)
        ...
        dropdown_selected.TextColor3 = Color3.fromRGB(220, 220, 220)
        dropdown_selected.TextSize = is_mobile and 12 or 13
        ...
        dropdown_arrow.Position = UDim2.new(0.8, 0, 0.2, 0)
        dropdown_arrow.Size = UDim2.new(0, 14, 0, 14)
        dropdown_arrow.Image = "rbxassetid://6031091004"
        dropdown_arrow.ImageColor3 = Color3.fromRGB(220, 220, 220)
        ...
        dropdown_scroll.Size = UDim2.new(1, 0, 1, 0)
        dropdown_scroll.CanvasSize = UDim2.new(0, 0, 0, 0)
        dropdown_scroll.ScrollBarThickness = is_mobile and 6 or 4
        ...
        local function update_list_height()
            ...
            local height = math.min(item_count * (is_mobile and 32 or 36) + 10, 150)
            dropdown_scroll.CanvasSize = UDim2.new(0, 0, 0, item_count * (is_mobile and 32 or 36))
            return height
        end
        ...
        local function toggle_dropdown()
            ...
            if is_open then
                ...
                dropdown_list.Position = UDim2.new(
                    ...
                    0, dropdown_button.AbsolutePosition.Y + dropdown_button.AbsoluteSize.Y + 5
                )
                dropdown_list.Size = UDim2.new(0, dropdown_button.AbsoluteSize.X, 0, 0)
        ...
        dropdown_button.Activated:Connect(toggle_dropdown)
        ...
        for i, option in ipairs(options) do
            ...
            option_button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
            option_button.BorderSizePixel = 0
            option_button.Size = UDim2.new(1, -10, 0, is_mobile and 30 or 34)
            option_button.Position = UDim2.new(0, 5, 0, (i-1)*(is_mobile and 32 or 36))
            ...
            option_button.Activated:Connect(select_option)
            ...
            table.insert(dropdown_items, option_button)
        end
        ...
        connection = user_input_service.InputBegan:Connect(function(input)
            if is_open and (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
                ...
                local button_pos = dropdown_button.AbsolutePosition
                local button_size = dropdown_button.AbsoluteSize
                
                local in_dropdown = mouse_pos.X >= dropdown_pos.X and mouse_pos.X <= dropdown_pos.X + dropdown_size.X and
                                   mouse_pos.Y >= dropdown_pos.Y and mouse_pos.Y <= dropdown_pos.Y + dropdown_size.Y
                
                local in_button = mouse_pos.X >= button_pos.X and mouse_pos.X <= button_pos.X + button_size.X and
                                 mouse_pos.Y >= button_pos.Y and mouse_pos.Y <= button_pos.Y + button_size.Y
                
                if not in_dropdown and not in_button then
                    toggle_dropdown()
                end
            end
        end)
    ...
    function window_methods:colorpicker(name, default_color, callback)
        local colorpicker_height = is_mobile and 38 or 42
        ...
        colorpicker_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        colorpicker_name.Font = Enum.Font.GothamMedium
        colorpicker_name.Text = name
        colorpicker_name.TextColor3 = Color3.fromRGB(230, 230, 230)
        colorpicker_name.TextSize = is_mobile and 13 or 14
        ...
        color_button.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        color_button.Position = UDim2.new(0.7, 0, 0.22, 0)
        color_button.Size = UDim2.new(0.25, 0, 0, is_mobile and 24 or 28)
        ...
        color_preview.BackgroundColor3 = default_color or Color3.fromRGB(0, 200, 255)
        color_preview.BorderSizePixel = 0
        color_preview.Position = UDim2.new(0.1, 0, 0.1, 0)
        color_preview.Size = UDim2.new(0.8, 0, 0, is_mobile and 20 or 22)
        ...
        local function show_color_picker()
            ...
            color_picker_frame.Size = UDim2.new(0, is_mobile and 280 or 320, 0, 0)
            color_picker_frame.ZIndex = 100
            ...
            color_wheel.Size = UDim2.new(0, is_mobile and 120 or 140, 0, is_mobile and 120 or 140)
            color_wheel.Image = "rbxassetid://14284893301"
            color_wheel.ZIndex = 101
            
            local color_selector = Instance.new("Frame")
            color_selector.Name = "ColorSelector"
            color_selector.Parent = color_wheel
            color_selector.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            color_selector.BorderSizePixel = 2
            color_selector.BorderColor3 = Color3.fromRGB(0, 0, 0)
            color_selector.Size = UDim2.new(0, 8, 0, 8)
            color_selector.Position = UDim2.new(0.5, -4, 0.5, -4)
            color_selector.ZIndex = 102
            
            local selector_corner = Instance.new("UICorner")
            selector_corner.CornerRadius = UDim.new(1, 0)
            selector_corner.Parent = color_selector
            ...
            color_display.Position = UDim2.new(0.55, 0, 0.05, 0)
            color_display.Size = UDim2.new(0, is_mobile and 100 or 120, 0, is_mobile and 40 or 45)
            ...
            hex_input.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
            hex_input.BorderSizePixel = 0
            hex_input.Position = UDim2.new(0.55, 0, 0.25, 0)
            hex_input.Size = UDim2.new(0, is_mobile and 100 or 120, 0, is_mobile and 30 or 35)
            hex_input.Font = Enum.Font.Gotham
            hex_input.PlaceholderText = "#FFFFFF"
            hex_input.Text = string.format("#%02X%02X%02X", r, g, b)
            hex_input.TextColor3 = Color3.fromRGB(230, 230, 230)
            hex_input.TextSize = is_mobile and 13 or 14
            ...
            local function create_rgb_slider(name, y_pos, value, color)
                ...
                container.Position = UDim2.new(0.55, 0, y_pos, 0)
                container.Size = UDim2.new(0, is_mobile and 100 or 120, 0, 25)
                ...
                name_label.Size = UDim2.new(0.3, 0, 1, 0)
                name_label.Font = Enum.Font.Gotham
                name_label.Text = name
                name_label.TextColor3 = Color3.fromRGB(220, 220, 220)
                name_label.TextSize = is_mobile and 12 or 13
                ...
                value_label.Position = UDim2.new(0, 0, 0, 0)
                value_label.Size = UDim2.new(0.3, 0, 1, 0)
                value_label.Font = Enum.Font.Gotham
                value_label.Text = tostring(value)
                value_label.TextColor3 = Color3.fromRGB(200, 200, 200)
                value_label.TextSize = is_mobile and 12 or 13
            ...
            local r_data = create_rgb_slider("R", 0.5, r, Color3.fromRGB(255, 50, 50))
            local g_data = create_rgb_slider("G", 0.62, g, Color3.fromRGB(50, 255, 50))
            local b_data = create_rgb_slider("B", 0.74, b, Color3.fromRGB(50, 50, 255))
            
            apply_button.Name = "ApplyButton"
            apply_button.Parent = color_picker_frame
            apply_button.BackgroundColor3 = Color3.fromRGB(0, 200, 255)
            apply_button.BorderSizePixel = 0
            apply_button.Position = UDim2.new(0.05, 0, 0.85, 0)
            apply_button.Size = UDim2.new(0.9, 0, 0, is_mobile and 32 or 36)
            apply_button.Font = Enum.Font.GothamSemibold
            apply_button.Text = "Apply"
            apply_button.TextColor3 = Color3.fromRGB(255, 255, 255)
            apply_button.TextSize = is_mobile and 14 or 15
            ...
            local function update_color()
                ...
                local wheel_size = color_wheel.AbsoluteSize
                local center = wheel_size.X / 2
                local radius = s * (center - 4)
                local angle = h * 2 * math.pi
                local x = center + radius * math.cos(angle)
                local y = center + radius * math.sin(angle)
                
                color_selector.Position = UDim2.new(0, x - 4, 0, y - 4)
            end
            ...
            local function get_wheel_color(x, y)
                local wheel_size = color_wheel.AbsoluteSize
                local center = wheel_size.X / 2
                local dx = x - center
                local dy = y - center
                ...
                if distance > center then
                    distance = center
                    dx = dx * center / distance
                    dy = dy * center / distance
                end
                ...
                local s = math.clamp(distance / center, 0, 1)
                local v = 1
            ...
            color_wheel.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local wheel_pos = color_wheel.AbsolutePosition
                    local x = pos.X - wheel_pos.X
                    local y = pos.Y - wheel_pos.Y
                    
                    local color = get_wheel_color(x, y)
                    r = math.floor(color.r * 255)
                    g = math.floor(color.g * 255)
                    b = math.floor(color.b * 255)
            ...
            color_wheel.InputChanged:Connect(function(input)
                if is_selecting and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    local pos = input.Position
                    local wheel_pos = color_wheel.AbsolutePosition
                    local x = pos.X - wheel_pos.X
                    local y = pos.Y - wheel_pos.Y
            ...
            local function apply_color()
                ...
                color_picker_frame:TweenSize(UDim2.new(0, is_mobile and 280 or 320, 0, 0), "Out", "Quad", 0.2, true, function()
                    color_picker_frame:Destroy()
                    color_picker_frame = nil
                end)
            end
            ...
            color_picker_frame:TweenSize(UDim2.new(0, is_mobile and 280 or 320, 0, is_mobile and 220 or 260), "Out", "Quad", 0.2, true)
            ...
            if right_space > (is_mobile and 300 or 340) then
                color_picker_frame.Position = UDim2.new(0, button_pos.X + button_size.X + 10, 0, button_pos.Y)
            elseif left_space > (is_mobile and 300 or 340) then
                color_picker_frame.Position = UDim2.new(0, button_pos.X - (is_mobile and 300 or 340), 0, button_pos.Y)
            else
        ...
        color_button.Activated:Connect(show_color_picker)
    ...
    function window_methods:textbox(name, placeholder, callback)
        local textbox_height = is_mobile and 58 or 62
        ...
        textbox_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        ...
        textbox_name.Size = UDim2.new(0.9, 0, 0, 22)
        textbox_name.Font = Enum.Font.GothamMedium
        textbox_name.Text = name
        textbox_name.TextColor3 = Color3.fromRGB(230, 230, 230)
        textbox_name.TextSize = is_mobile and 13 or 14
        ...
        textbox_input.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        textbox_input.BorderSizePixel = 0
        textbox_input.Position = UDim2.new(0.05, 0, 0.45, 0)
        textbox_input.Size = UDim2.new(0.9, 0, 0, is_mobile and 30 or 32)
        textbox_input.Font = Enum.Font.Gotham
        textbox_input.PlaceholderText = placeholder or "Enter text..."
        textbox_input.Text = ""
        textbox_input.TextColor3 = Color3.fromRGB(230, 230, 230)
        textbox_input.TextSize = is_mobile and 13 or 14
    ...
    function window_methods:label(text)
        ...
        label_container.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
        label_container.BackgroundTransparency = 0
        label_container.Size = UDim2.new(0.92, 0, 0, is_mobile and 34 or 36)
    ...
    function window_methods:separator()
        ...
        separator_container.Size = UDim2.new(0.92, 0, 0, is_mobile and 12 or 14)
        
        separator_line.Name = "SeparatorLine"
        separator_line.Parent = separator_container
        separator_line.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
